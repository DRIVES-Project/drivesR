...
The harmonize_treatments_units_crops function produces a dataframe with one row per unit_id, year, and expected crop_id. Treatment information is organized in separate columns as in harmonize_treatments_units. This function is useful for making template cropping sequences. It also contains most of the columns from the rotation_phases table. 
