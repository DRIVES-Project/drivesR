...
- counterclockwise_angle_deg:
  ...
  The rotation angle counterclockwise from true north (negative
  bearing).

- origin:

  A 1-row matrix of X followed by Y coordinates of the origin (usually
  lon, lat projected to meters).
