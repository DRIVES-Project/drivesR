...
#'
#' @return a vector of TRUE and FALSE indicating whether each date is in ISO format.
#' @export
#'
#' @examples
#' myd = c("2024-01-01","2022-01-01","6/23/22","24-01-01")
#' is.ISOdate(myd)
is.ISOdate <- function(d){
  dvec <- as.character(as.Date(d))
  return(!is.na(dvec) & substr(dvec,1,2)!="00")
}